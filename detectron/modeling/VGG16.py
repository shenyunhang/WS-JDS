...
def add_VGG16_conv5_body_origin(model):
    ...
    if cfg.WSL.DILATION == 2:
        ...
        model.Conv(
            'pool4', 'conv5_1', 512, 512, 3, pad=2, stride=1, dilation=2)
        model.Relu('conv5_1', 'conv5_1')
        model.Conv(
            'conv5_1', 'conv5_2', 512, 512, 3, pad=2, stride=1, dilation=2)
        model.Relu('conv5_2', 'conv5_2')
        model.Conv(
            'conv5_2', 'conv5_3', 512, 512, 3, pad=2, stride=1, dilation=2)
